...
constexpr auto kGameplayChromeCoverageManifest = std::to_array<Entry>({
    ...
    {"exploration.action.character_sheet", Surface::exploration,
        ...
        "No semantic control replaces Classic's main character-sheet button.",
        "src/realmz_orig/buttonchoice.c::buttonchoice/charmainbut"},
    {"exploration.action.rest", Surface::exploration,
        Kind::interaction, Status::missing,
        "No semantic control replaces the Classic Rest command.",
        "src/realmz_orig/buttonchoice.c::buttonchoice/rest"},
    {"exploration.action.camp", Surface::exploration,
        Kind::interaction, Status::missing,
        "No semantic control replaces the Classic Camp command.",
        "src/realmz_orig/buttonchoice.c::buttonchoice/campbut"},
    {"exploration.action.search_toggle", Surface::exploration,
        Kind::interaction, Status::missing,
        "No semantic control replaces the persistent Classic search toggle.",
        "src/realmz_orig/buttonchoice.c::buttonchoice/search"},
    {"exploration.action.use_torch", Surface::exploration,
        Kind::interaction, Status::missing,
        "No semantic control consumes and uses a torch item as Classic does.",
        "src/realmz_orig/buttonchoice.c::buttonchoice/torch"},
    {"exploration.action.contextual_overview", Surface::exploration,
        Kind::interaction, Status::missing,
        "Make Scroll and Area Search still share a Classic contextual button.",
        "src/realmz_orig/buttonchoice.c::buttonchoice/overviewbut"},
    ...
    {"exploration.action.use_scroll", Surface::exploration,
        Kind::interaction, Status::missing,
        "No semantic control replaces Classic out-of-combat scroll use.",
        "src/realmz_orig/buttonchoice.c::buttonchoice/viewspellsbut"},
    ...
    {"exploration.info.search_and_torch_state", Surface::exploration,
        Kind::essential_information, Status::missing,
        "The shell does not present Classic's persistent search and torch state.",
        "src/realmz_orig/buttonchoice.c::buttonchoice/search"},
